    ...
    <div className={isCompact ? '' : 'mb-8 p-4 bg-white/50 dark:bg-zinc-800/50 rounded-lg'}>
      ...
      <div className="flex flex-wrap justify-center gap-3">
        <button
          ...
          className="px-4 py-2 bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300 rounded-lg text-sm font-medium hover:bg-violet-200 dark:hover:bg-violet-900/50 transition-colors disabled:opacity-50 flex items-center gap-2"
        >
