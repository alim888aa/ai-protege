...
export function CTASection() {
  ...
  return (
    <section className="px-3 pb-12 md:px-6 lg:px-8">
      <div className="mx-auto grid w-full max-w-[1380px] overflow-hidden rounded-[26px] border border-white/10 bg-zinc-900 text-white md:grid-cols-[minmax(0,1.5fr)_minmax(300px,0.75fr)] md:items-stretch">
        ...
        <div className="flex items-center justify-center p-7 md:border-l md:border-white/10 md:p-12 lg:p-16">
          <Link
            href={ctaHref}
